require('./Devices/RosouLexiuCirculationFan');
...
module.exports = function(homebridge) {
    ...
    homebridge.registerPlatform('homebridge-leshow-fan', 'MiFanPlatform', MiFanPlatform, true);
}
    ...
    accessories: function(callback) {
        ...
        if(deviceCfgs instanceof Array) {
            for (var i = 0; i < deviceCfgs.length; i++) {
                ...
                if (deviceCfg['type'] == "leshow.fan.ss320") {
                    new RosouLexiuCirculationFan(this, deviceCfg).forEach(function(accessory, index, arr){
